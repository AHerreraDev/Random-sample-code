...
document.querySelector('.btn-roll').addEventListener('click', function(){
    ...
    //Update round score if dice number was NOT a 1
    if (dice !== 1) {
        // add value
        roundScore += dice;
...
document.querySelector('.btn-hold').addEventListener('click', function(){
    ...
    if (scores[activePlayer] >= 75) {
        ...
        document.querySelector('.player-'+ activePlayer +'-panel').classList.remove('active'); // Remove active class
        gamePlaying = false;
